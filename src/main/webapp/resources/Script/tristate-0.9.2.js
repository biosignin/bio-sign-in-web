...
function setDefaultConfig(baseurl)
{
	DEFAULT_CONFIG[UNCHECKED_NORM]=baseurl+'Images/chk3-unchecked.gif';
	DEFAULT_CONFIG[UNCHECKED_HILI]=baseurl+'Images/chk3-unchecked_highlighted.gif';
	DEFAULT_CONFIG[INTERMEDIATE_NORM]=baseurl+'Images/chk3-intermediate.gif';
	DEFAULT_CONFIG[INTERMEDIATE_HILI]=baseurl+'Images/chk3-intermediate_highlighted.gif';
	DEFAULT_CONFIG[CHECKED_NORM]=baseurl+'Images/chk3-checked.gif';
	DEFAULT_CONFIG[CHECKED_HILI]=baseurl+'Images/chk3-checked_highlighted.gif';
}
...
function initTriStateCheckBox(triStateBoxId, containerOrStateFieldId, standAloneMode, baseUrl) {
	setDefaultConfig(baseUrl);
